...
const SystemType = builder
  ...
  .implement({
    fields: t => ({
      ...
      systemSolarMass: t.exposeFloat("systemSolarMass"),
      solarRadiusAverage: t.exposeFloat("solarRadiusAverage"),
      solarTemperatureTotal: t.exposeFloat("solarTemperatureTotal"),
...
builder.mutationFields(t => ({
  createSystem: t.field({
    ...
    args: {
      ...
      systemSolarMass: t.arg.float({ required: true }),
      solarRadiusAverage: t.arg.float({ required: true }),
      solarTemperatureTotal: t.arg.float({ required: true }),
    ...
    resolve: async (_, args) => System.create(
      ...
      args.subsectorY, 
      args.systemName,
      args.systemSolarMass,
      args.solarRadiusAverage,
      args.solarTemperatureTotal,
